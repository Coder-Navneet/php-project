                    ...
                    <div class="col">
                        ...
                        <ul class="list-group">
                            ...
                            while ( $row_data = mysqli_fetch_assoc($result_brand)) {
                                ...
                                // echo $category_name;
                                echo '<li class="list-group-item"><a href="index.php?brand='.$brand_id.'" class="text-dark text-decoration-none"><h5>'.$brand_name.'</h5></a></li>  ';
                            }
                            ?>
                        </ul>
                    </div>
                       ...
                       <div class="col">
                        ...
                        <ul class="list-group">
                            ...
                            while ( $row_data = mysqli_fetch_assoc($result_category)) {
                                ...
                                // echo $category_name;
                                echo '<li class="list-group-item"><a href="index.php?category='.$category_id.'" class="text-dark text-decoration-none"><h5>'.$category_name.'</h5></a></li>  ';
                            }
                            ?>
